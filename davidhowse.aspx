<%@ Page Language="C#" AutoEventWireup="true" CodeFile="davidhowse.aspx.cs" Inherits="davidhowse" %>
...
footer {padding:1em;
   ...
   margin-left: 400px;
    ...
    <asp:Label ID="Label1" runat="server" CssClass="auto-style2" Text="DR. DAVID HOWSE"></asp:Label>
