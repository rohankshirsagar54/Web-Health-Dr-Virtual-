<%@ Page Language="C#" AutoEventWireup="true" CodeFile="haroldbrucesweet.aspx.cs" Inherits="haroldbrucesweet" %>
...
footer {padding:1em;
   ...
   margin-left: 400px;
    ...
    <asp:Label ID="Label1" runat="server" CssClass="auto-style2" Text="DR. HAROLD BRUCE SWEET"></asp:Label>
