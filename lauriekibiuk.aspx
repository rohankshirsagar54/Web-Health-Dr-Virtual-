<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lauriekibiuk.aspx.cs" Inherits="lauriekibiuk" %>
...
footer {padding:1em;
   ...
   margin-left: 400px;
    ...
    <asp:Label ID="Label1" runat="server" CssClass="auto-style2" Text="DR. LAURIE KIBIUK"></asp:Label>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label10" runat="server" CssClass="auto-style11" Text="980 OLIVER ROAD, THUNDER BAY, ON, CANADA"></asp:Label>
  <footer/></div>  </form>
